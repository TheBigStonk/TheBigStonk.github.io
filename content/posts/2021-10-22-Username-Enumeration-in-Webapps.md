...
- Credential Stuffing: Where a previously used password is relayed to other accounts to check for password resuse. - Brute Force: Most likely using a wordlist of commonly used passwords to check for low hanging fruit. - Phishing: Taking the domain and discovered usernames to produce a plausible looking password reset to capture creds that way.
...
- How rate limiting is analysed to indicate threats to the system
