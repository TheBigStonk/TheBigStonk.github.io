...
`if($_GET['login']=="1"){ // Note: An Equal strcmp() will return 0 if(strcmp($_POST['user'], "admin") == 0 && strcmp($_POST['password'], "quantumbucks") == 0){ echo "Welcome hacker"; }else{ echo "lol no"; }`
